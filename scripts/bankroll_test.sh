...
PAIRS=(
  ...
  "MOMENTUM_INSIDER_DISTRIB_MAX_SOLD=0.5"
  "MOMENTUM_MIN_BASE_SCORE=0"

  # --- learning + smart-money + avoidance: ALL ON (the brains) ---
  "MOMENTUM_ALPHA_FOLLOW=true"
  "MOMENTUM_ALPHA_MIN_WALLET_SCORE=60"
  "MOMENTUM_CONVERGENCE_MIN=2"
  "MOMENTUM_CONVERGENCE_BOOST=55"
  "MOMENTUM_WATCH_ENABLED=true"
  "MOMENTUM_WATCH_AUTOBUY=false"
  "MOMENTUM_CREATOR_AVOID=true"
  "MOMENTUM_PATTERN_AVOID=true"
  "MOMENTUM_DECISION_LOG=momentum_decisions"
  "MOMENTUM_OUTCOME_HORIZON_SECS=7200"
